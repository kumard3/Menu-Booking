...
export const OrdersPage = ({
  ...
  //   newOrder + newOrder2 + newOrder3 + newOrder4 + newOrder5 + newOrder6 + newOrder7 + newOrder8 + newOrder9 
...
// function totalOrders() {
//   setTotalOrder( orders.length+orders2.length+orders3.length+orders4.length+orders5.length+orders6.length+orders7.length+orders8.length+orders9.length)
// }
